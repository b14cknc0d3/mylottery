...
class MyHomePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text("SaleStatus Chart Sample"),
      ),
      body: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ListTile(
              title: Text("Daily Sale Rank Demo"),
              subtitle: Text("SaleData Chart"),
              onTap: () => _onTap(
                context,
                sample1(context),
              ),
              ...
              child: BezierChart(
                ...
                series: const [
                  BezierLine(
                    label: "tickets",
                    data: const [
                      DataPoint<double>(value: 50, xAxis: 0),
                      DataPoint<double>(value: 130, xAxis: 4),
                      DataPoint<double>(value: 200, xAxis: 10),
                      DataPoint<double>(value: 150, xAxis: 15),
                      DataPoint<double>(value: 75, xAxis: 20),
                      DataPoint<double>(value: 0, xAxis: 25),
                      DataPoint<double>(value: 100, xAxis: 30),
            ...
            series: const [
              BezierLine(
                ...
                data: const [
                  ...
                  DataPoint<double>(value: 200, xAxis: 15),
                  DataPoint<double>(value: 75, xAxis: 20),
                  DataPoint<double>(value: 0, xAxis: 25),
                  DataPoint<double>(value: 5, xAxis: 30),
                  DataPoint<double>(value: 400, xAxis: 35),
                ],
              ),
              BezierLine(
