...
class UserSaleListEditPage extends StatefulWidget {
  final SaleListAddBloc saleListAddBloc;
  final OneLs item;

  const UserSaleListEditPage ({Key key, this.saleListAddBloc, @required this.item}) : super( key: key );

  @override
  _UserSaleListEditPageState createState () =>
      _UserSaleListEditPageState( );
}

class _UserSaleListEditPageState extends State<UserSaleListEditPage> {
  ...
  Widget build (BuildContext context) {
    ...
    return BlocListener<SaleListAddBloc, SaleListAddState>(
      listener: (context, state) {
              ...
              SnackBar(
                content: Row(
                  ...
                  children: [
                    ...
                    Text( 'adding data' ), Icon( Icons.add )],
                ),
        ...
        } else if (state is SaleListPatchSuccessState) {
          _scaffoldKey.currentState
            ..hideCurrentSnackBar( )
            ..showSnackBar(
              SnackBar(
...
//controller: _lnoTEC..text ='${_item.lno == null ? '':_item.lno}',
                                    autofocus: false,
                                    controller: _lnoTEC..text ='${widget.item.lno}' ,
                          ...
                          Padding(
                            ...
                            child: TextFormField(
                              autofocus: false,
                              controller: _phone..text ='${widget.item.phone}',
                              textAlign: TextAlign.center,
                              decoration: InputDecoration(
                                  border: OutlineInputBorder(
                                      borderRadius: BorderRadius.circular( 30 ),
                          ...
                          Padding(
                            ...
                            child: TextFormField(
                              autofocus: false,
                              controller: _address..text ='${widget.item.address}',
                              textAlign: TextAlign.center,
                              decoration: InputDecoration(
                                  border: OutlineInputBorder(
                                      borderRadius: BorderRadius.circular( 30 ),
...
//                                  backgroundColor: Colors.amber,
  ...
  _onSaleAdd (BuildContext context) {
    ...
    saleListAddBloc.dispatch( SaleListPatchBottomPressed( items: listOneLs ) );
  }
