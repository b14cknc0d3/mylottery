...
class SaleListEditPage extends StatefulWidget {
  final SaleListAddBloc saleListAddBloc;
  final OneLs item;

  const SaleListEditPage ({Key key, this.saleListAddBloc, @required this.item}) : super( key: key );

  @override
  _SaleListEditPageState createState () =>
      _SaleListEditPageState( );
}

class _SaleListEditPageState extends State<SaleListEditPage> {
